                    ...
                    <ContentTemplate>
                        ...
                        <table width="330px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTendangnhap" runat="server" Height="20px" Width="170px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMatkhau" runat="server" Height="20px" Width="170px" TextMode="Password"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:ImageButton ID="ibtnLogin" runat="server"
                                        ImageUrl="~/images/img/login.png" CssClass="button_login"
