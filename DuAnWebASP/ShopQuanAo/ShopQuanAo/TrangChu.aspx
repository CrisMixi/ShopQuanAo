...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat ="server">
     <div id="slider_holder" class="theme-default">
        	<div id="slider" class="nivoSlider">
           	 <img src="images/img/banner1.jpg" data-thumb="images/img/banner1.jpg" alt="" />
                <a href="#"><img src="images/img/banner2.jpg" data-thumb="images/img/banner2.jpg" alt="" title="Không còn vẻ cứng nhắc khi đến công sở, những chiếc áo sơ mi thiết kế kiểu cách giúp bạn tự tin , giấu bớt nhược điểm" /></a>
                <img src="images/img/banner10.jpg" data-thumb="images/img/banner10.jpg" alt="" data-transition="slideInLeft" />
                <img src="images/img/banner3.png" data-thumb="images/img/banner3.png" alt="" title="#htmlcaption" />
                <img src="images/img/banner4.jpg" data-thumb="images/img/banner4.jpg" alt="" title="#htmlcaption" />
                <img src="images/img/banner5.jpg" data-thumb="images/img/banner5.jpg" alt="" title="#htmlcaption" />
            </div>
